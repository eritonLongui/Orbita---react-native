export const themeColors = {
  ...
  glassBarBorder: 'rgba(255, 255, 255, 0.12)',
  glassBarHighlight: 'rgba(255, 255, 255, 0.06)',
  ...
  textSubtle: '#525252',
  /** Legendas e apoio em cards — legível sem competir com o valor */
  textSupport: '#7A8494',
  textSupportMuted: '#636D7E',
